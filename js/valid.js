$(document).ready(function () {
    ...
    }, "Имя должно быть длиннее 2 символов, без специальных символов и пробелов");

    $.validator.addMethod("lastusernameRegex", function (value, element) {
        return this.optional(element) || regex_first_last_name.test(value);
    }, "Фамилия должна быть длиннее 2 символов без специальных символов и пробелов.");

    $.validator.addMethod("phoneRegex", function (value, element) {
        return this.optional(element) || /^(\d[- ]?){7,11}$/.test(value);
    }, "Номер должен содержать от 7 до 11 символов без специальных символов.");
